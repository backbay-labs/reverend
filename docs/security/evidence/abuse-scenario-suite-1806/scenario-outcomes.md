# Abuse Scenario Outcomes (Issue 1806)
...
- `S1` log: `docs/security/evidence/abuse-scenario-suite-1806/scenario-01-no-direct-agent-write.log`
- `S1` artifact: `docs/security/evidence/abuse-scenario-suite-1806/no-direct-agent-write/no-direct-agent-write-invariant.json`
- `S1` artifact: `docs/security/evidence/abuse-scenario-suite-1806/no-direct-agent-write/no-direct-agent-write-invariant.md`
- `S2` log: `docs/security/evidence/abuse-scenario-suite-1806/scenario-02-allowlist-egress.log`
- `S3` log: `docs/security/evidence/abuse-scenario-suite-1806/scenario-03-policy-mode-scope.log`
- `S4` log: `docs/security/evidence/abuse-scenario-suite-1806/scenario-04-provenance-chain.log`
- `S5` log: `docs/security/evidence/abuse-scenario-suite-1806/scenario-05-receipt-tamper.log`
